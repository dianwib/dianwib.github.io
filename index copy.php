                    ...
                    <div class="col-lg-7 col-12">
                        <div class="hero-text">
                            <div class="hero-title-wrap d-flex align-items-center mb-4">
                                ...
                                <h1 class="hero-title ms-3 mb-0">Hi there!</h1>
                            </div>

                            <h2 class="mb-4">Available for freelance project.</h2>
                    ...
                    <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                        <div class="about-thumb">
                            ...
                            <p style="text-align: justify;">
                                A passionate programmer with six years of experience in point-of-sales systems, e-commerce, ERP, and government projects. Skilled in teamwork and independent work, with a strong ability to adapt.
                            </p>
                            <p style="text-align: justify;">
                                Enthusiastic about Machine Learning, continuously learning and leveraging the latest technologies to drive innovation and efficiency.
                            </p>
